...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['factura']['name'])) {
        ...
        $factura_imagen = str_replace('../', '', $factura_imagen); // para guardar ruta relativa
    }

    $db = new Database();
    $conn = $db->conectar();
    $sql = "INSERT INTO entradas (tipo, monto, fecha, factura_imagen, usuario_id) VALUES (?, ?, ?, ?, ?)";
...
include '../views/registrar_entrada_view.php';
